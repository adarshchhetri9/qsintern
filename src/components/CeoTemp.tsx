...
import { star, verBlue, verWhite } from "../../public/assets";
        ...
        <div className="flex justify-around bg-gradient-to-r from-[#223E83] via-[#162967] to-[#313985]">
          <div className="text-white ">
            <Image
              src={verWhite}
              alt="werWhite "
              className="relative md:right-20 right-4 top-4"
            />
            <div className="relative md:top-16 top-8">
              <h1 className="text-2xl font-semibold">Sally Radley</h1>
              <p className="font-normal">WebGFi - CEO</p>
            </div>
          </div>
          <div className="h-32 bg-blue-600 rounded-lg relative top-10 w-32 md:w-52 md:h-52"></div>
        </div>
      </div>
      <div className="flex flex-col ">
        <Image src={star} alt="star" className="md:mx-20 ml-2 mt-2  " />
